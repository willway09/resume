...
\usepackage[margin=.75in,tmargin=.5in,bmargin=.5in]{geometry} % For margins
...
\item Migrating lab codebase into an object-oriented paradigm.
\item Designing Shiny user interface to allow non-coders to run simulations.
\end{CustomItemize}
