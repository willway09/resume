...
\usepackage[margin=.75in]{geometry} % For margins
...
\begin{CustomItemize}
\item Buddy at Camp I Am Special (disabilities summer camp) in the summers of 2017, 2018 and 2019 for a total of 363 service hours - 
involved one-on-one partnership with camper, introduced crisis management concepts.
...
\vspace{.25em}
\section{Activities, Awards and Honors}
...
\item Knots (Riverbend District champion for 3 years)
\item Orienteering/Navigation
\item Camping/Hiking
\end{CustomItemize}
\hfill}
\spacetextbox{\hfil\hfil}
...
\begin{CustomItemize}
\item General computer skills: Microsoft Office
\item 3D modeling and printing
\item Fluency in Java, C, C++
\end{CustomItemize}
}
