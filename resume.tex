...
%Put home address here, if can tolerate security risk
...
%\item Worked as undergraduate from Spring 2024 to Winter 2024, currently in postbaccalaureate position.
...
%\item Working on project to catalog VLF decades-old VLF data archive for efficient data retrieval.
...
%\subsection{Garrett Plant Pathology Lab - Paid Undergraduate Researcher (Fall 2021 - Fall 2023)}
%\begin{CustomItemize}
...
\item Fluency: Java, C, C++, Julia
\item Competency: JavaScript, HTML, CSS, Go, \LaTeX{}, MATLAB, R, SQL, VHDL, Verilog, LabVIEW
\end{CustomItemize}
\hfill}
\spacetextbox{\hfil\hfil}
\halftextbox{\hfill
